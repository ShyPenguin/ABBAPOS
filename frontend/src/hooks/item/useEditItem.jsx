...
const putItem = async (id, data, token, toastId) => {
  try {
    toastId = toast.loading("Loading...", {
      position: "top-right",
      theme: "dark",
    });
    const feedBack = await API.put(`items/${id}/`, data, {
...
export const useEditItem = (setIsItemFormVisible) => {
