    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(blank=True, max_length=255, verbose_name='business category')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('business', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='categories', to='api.business')),
            ],
        ),
        migrations.CreateModel(
            name='Customer',
            fields=[
                ...
                ('code', models.CharField(max_length=50, unique=True, verbose_name='customer Code')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('HLD', 'Hold'), ('PD', 'Paid'), ('CHG', 'Charged'), ('VD', 'Void')], default='HLD', max_length=3, verbose_name='Status')),
                ('discount', models.DecimalField(decimal_places=2, default=0, max_digits=10, null=True, verbose_name='Discount')),
                ('business', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.business', verbose_name='Business')),
                ('customer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.customer', verbose_name='Customer')),
                ('items', models.ManyToManyField(to='api.item', verbose_name='Items')),
            ],
        ),
        migrations.CreateModel(
            name='CustomUser',
